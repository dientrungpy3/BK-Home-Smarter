...
public class MQTTService {
    ...
    final String clientId = "testing";
    final String subscriptionTopic = "dientrungpy3/feeds/bathroom.bathroom-light-1";
    final String username = "dientrungpy3";
    final String password = "aio_Uqiu853wto6vTYYNMUlCF3LDW5Iq";
